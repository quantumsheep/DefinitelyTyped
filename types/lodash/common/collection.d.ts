...
declare module "../index" {
    ...
    interface LoDashExplicitWrapper<TValue> {
         ...
         * @see _.invokeMap
         */
        invokeMap<K extends keyof TValue, TResult extends TValue[K] extends (...args: any) => any ? ReturnType<TValue[K]> : any>(collection: TValue[] | Record<string, TValue> | object | null | undefined, methodName: K | string, ...args: any[]): CollectionChain<TResult>;
        /**
         * @see _.invokeMap
         */
